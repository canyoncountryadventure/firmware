...
ProcessMessage DistanceSensorModule::handleReceived(const meshtastic_MeshPacket &mp)
{
    ...
    if (strcmp(command, "HELP") == 0) {
        ...
        sendTextReply(mp.from, mp.channel,
                      "WATER 2/2: WATER CAL STATUS | WATER CAL STAGE 1.42FT | WATER CAL LOCK | WATER CAL UNLOCK | WATER CAL UNLOCK CONFIRM | WATER CAL RESET | WATER CAL RESET CONFIRM | WATER RESET WATER | WATER RESET WATER CONFIRM | WATER TELEMETRY NOW");
        return ProcessMessage::CONTINUE;
    }
