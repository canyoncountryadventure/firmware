...
| **Seeed Water Distance + HOBO v2** | XIAO nRF52840 + Wio-SX1262 + water distance + HOBO | **Not published in V2 catalog** | **Not published in V2 catalog** | [branch](https://github.com/canyoncountryadventure/firmware/tree/Seeed-Water-Distance-HOBO-v2) |
...
| Seeed Water Distance + HOBO v2 | **No published matching V2 Scout image; do not use another model's firmware.** |
