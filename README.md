...
The Seeed Water + HOBO target uses a stable HOBO central-only BLE role and the standard `0x20006000` application RAM origin because dual-role Bluefruit resets this XIAO/S140 combination; phone BLE is disabled while LoRa, sensors, the mesh DFU hook, and bootloader drone DFU remain available.
